    ...
    where Unit : GridPosition
{
    ...
    //取空的导航数据
    private NavigationData GetEmptyNavigationData(Unit thisGrid, NavigationData preGrid, int G, int H)
    {
        //优先从池中取
    ...
    //查看是否节点在列表中
    private NavigationData Exits(List<NavigationData> list, Unit target)
    {
